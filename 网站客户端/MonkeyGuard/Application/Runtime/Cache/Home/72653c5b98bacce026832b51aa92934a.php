...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-user fa-fw"></i>人脸库</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($i % 2 );++$i;?><div class="col-lg-6">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <?php echo ($vi["num"]); ?>
                            </div>
                            <div class="panel-body">
                                <a href=<?php echo ($vi["img"]); ?>>
                                    <div class="col-lg-4"><img src=<?php echo ($vi["img"]); ?> width="120%" height="100%"/></div>
                                </a>
                                <div class="col-lg-4">
                                    <table width="90%" height="100%">
                                        ...
                                        <tr>
                                            <td width="65%">标记</td>
                                            <td width="35%"><?php echo ($vi["name"]); ?></td>
                                        </tr>
                                        <tr>
                                            <td width="60%">标记次数</td>
                                            <td width="40%"><?php echo ($vi["times"]); ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <form action="" method="get">
                                <a href="#">
                                    <div class="panel-footer">
                                        ...
                                        <span class="pull-right">删除标记 </span>

                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- /.table-responsive -->
                            <div class="panel-heading">
                                <a href="<?php echo U('tables');?>?month=1"><button type="button" class="btn btn-outline btn-default">01月</button></a>
                                <a href="<?php echo U('tables');?>?month=2"><button type="button" class="btn btn-outline btn-primary">02月</button></a>
                                <a href="<?php echo U('tables');?>?month=3"><button type="button" class="btn btn-outline btn-success">03月</button></a>
                                <a href="<?php echo U('tables');?>?month=4"><button type="button" class="btn btn-outline btn-info">04月</button></a>
                                <a href="<?php echo U('tables');?>?month=5"><button type="button" class="btn btn-outline btn-warning">05月</button></a>
                                <a href="<?php echo U('tables');?>?month=6"><button type="button" class="btn btn-outline btn-danger">06月</button></a>
                                <a href="<?php echo U('tables');?>?month=7"><button type="button" class="btn btn-outline btn-default">07月</button></a>
                                <a href="<?php echo U('tables');?>?month=8"><button type="button" class="btn btn-outline btn-primary">08月</button></a>
                                <a href="<?php echo U('tables');?>?month=9"><button type="button" class="btn btn-outline btn-success">09月</button></a>
                                <a href="<?php echo U('tables');?>?month=10"><button type="button" class="btn btn-outline btn-info">10月</button></a>
                                <a href="<?php echo U('tables');?>?month=11"><button type="button" class="btn btn-outline btn-warning">11月</button></a>
                                <a href="<?php echo U('tables');?>?month=12"><button type="button" class="btn btn-outline btn-danger">12月</button></a>
                            </div>
                        </div>

            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 style="margin-top: 0px; font-size: 16px">今日每小时温度变化</h4>
                            <form action="" method="GET">
                                <div class="" data-date="" data-date-format="yyyy-mm-dd"  >
                                    <div class="input-group custom-search-form">
                                        <input type="date" name="begin" class="form-control" placeholder="搜索..." required>
                                        <span class="input-group-btn">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="flot-chart">
                                <div id="line" class="flot-chart-content">  </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> 异常天数比例
